import { CreateUserRequest, LoginUserRequest, LogoutUserRequest, UpdateUserRequest } from './../../../globals/interfaces/auth';
import { Test, TestingModule } from "@nestjs/testing";
import { UsersService } from "../users.service";
import { RedisService } from "../../redis/redis.service";
import { mockRedisService } from "../__mocks__/redis.service";
...
describe('UsersService', () => {
    ...
    describe('"login" method', () => {
        ...
        it('should throw an error if password is incorrect', async () => {
            ...
            await expect(usersService.login(loginUserRequest)).rejects.toThrow(RpcException);
        });
    });
